...
export const LANDING_COPY: Record<Lang, LandingCopy> = {
  id: {
    ...
    harga: {
      ...
      addonTag: "Opsional", addonTitle: "Smart Plug Terintegrasi Sistem NEXBILL", addonFromPrefix: "Mulai dari ", addonPriceSuffix: "/unit, sekali beli",
  ...
  en: {
    ...
    harga: {
      ...
      addonTag: "Optional", addonTitle: "Smart Plug Integrated with NEXBILL", addonFromPrefix: "Starting from ", addonPriceSuffix: "/unit, one-time purchase",
  ...
  ms: {
    ...
    harga: {
      ...
      addonTag: "Pilihan", addonTitle: "Smart Plug Bersepadu dengan Sistem NEXBILL", addonFromPrefix: "Bermula dari ", addonPriceSuffix: "/unit, bayaran sekali",
  ...
  th: {
    ...
    harga: {
      ...
      addonTag: "ทางเลือกเสริม", addonTitle: "สมาร์ทปลั๊กที่เชื่อมต่อกับระบบ NEXBILL", addonFromPrefix: "เริ่มต้นที่ ", addonPriceSuffix: "/ชิ้น ซื้อครั้งเดียว",
  ...
  vi: {
    ...
    harga: {
      ...
      addonTag: "Tùy chọn", addonTitle: "Smart Plug Tích hợp với Hệ thống NEXBILL", addonFromPrefix: "Bắt đầu từ ", addonPriceSuffix: "/thiết bị, mua một lần",
  ...
  fil: {
    ...
    harga: {
      ...
      addonTag: "Opsyonal", addonTitle: "Smart Plug na Naka-integrate sa Sistema ng NEXBILL", addonFromPrefix: "Simula sa ", addonPriceSuffix: "/unit, isang beses na bili",
