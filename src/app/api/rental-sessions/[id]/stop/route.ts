...
/** Stop a session: computes the bill (flat package price, no overtime — see stopRentalSession's own doc comment — or rounded hourly for non-package sessions), frees the unit, and creates an order ready for checkout. */
