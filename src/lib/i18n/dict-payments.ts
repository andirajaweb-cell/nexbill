 ...
 */
registerDict({
  "payments.instructions.heading": { id: "Arahkan pelanggan membayar ke:", en: "Direct the customer to pay to:", ms: "Arahkan pelanggan membayar kepada:", th: "ให้ลูกค้าชำระเงินไปที่:", fil: "Ipabayad sa customer sa:", vi: "Hướng dẫn khách thanh toán đến:" },
  "payments.instructions.missing": { id: "Belum ada arahan pembayaran untuk {method}. Tambahkan gambar QRIS atau rekening outlet di menu Pembayaran supaya bisa ditunjukkan ke pelanggan.", en: "No payment instructions for {method} yet. Add your outlet's QRIS image or bank account in Payment Methods so it can be shown to the customer.", ms: "Belum ada arahan pembayaran untuk {method}. Tambah gambar QRIS atau akaun bank outlet di menu Kaedah Pembayaran.", th: "ยังไม่มีคำแนะนำการชำระเงินสำหรับ {method} เพิ่มรูป QRIS หรือบัญชีธนาคารของสาขาในเมนูวิธีการชำระเงิน", fil: "Wala pang instruksyon sa pagbabayad para sa {method}. Magdagdag ng QRIS image o bank account ng outlet sa Payment Methods.", vi: "Chưa có hướng dẫn thanh toán cho {method}. Thêm ảnh QRIS hoặc tài khoản ngân hàng của cửa hàng trong mục Phương thức thanh toán." },
  "payments.instructions.showCustomer": { id: "Perbesar untuk ditunjukkan ke pelanggan", en: "Enlarge to show the customer", ms: "Besarkan untuk ditunjukkan kepada pelanggan", th: "ขยายเพื่อแสดงให้ลูกค้า", fil: "Palakihin para ipakita sa customer", vi: "Phóng to để cho khách xem" },
  "payments.instructions.bank": { id: "Rekening", en: "Bank account", ms: "Akaun bank", th: "บัญชีธนาคาร", fil: "Bank account", vi: "Tài khoản ngân hàng" },
  "payments.instructions.copy": { id: "Salin nomor rekening", en: "Copy account number", ms: "Salin nombor akaun", th: "คัดลอกเลขบัญชี", fil: "Kopyahin ang account number", vi: "Sao chép số tài khoản" },
  "payments.instructions.holder": { id: "a.n.", en: "Account name:", ms: "Nama pemegang:", th: "ชื่อบัญชี:", fil: "Pangalan:", vi: "Chủ TK:" },
  "payments.instructions.scan": { id: "Minta pelanggan scan QRIS ini.", en: "Ask the customer to scan this QRIS.", ms: "Minta pelanggan imbas QRIS ini.", th: "ให้ลูกค้าสแกน QRIS นี้", fil: "Ipa-scan sa customer ang QRIS na ito.", vi: "Nhờ khách quét mã QRIS này." },
  "payments.instructions.confirmHint": { id: "Tandai lunas setelah dana benar-benar masuk ke rekening/aplikasi outlet.", en: "Mark as paid only after the money has actually arrived in the outlet's account/app.", ms: "Tandakan lunas selepas dana benar-benar masuk ke akaun/aplikasi outlet.", th: "ทำเครื่องหมายชำระแล้วหลังเงินเข้าบัญชี/แอปของสาขาจริง", fil: "Markahan bilang bayad kapag pumasok na talaga ang pera sa account/app ng outlet.", vi: "Chỉ xác nhận đã thanh toán khi tiền thực sự vào tài khoản/ứng dụng của cửa hàng." },
  "payments.form.instructionsHeading": { id: "Arahan untuk pelanggan (opsional)", en: "Customer instructions (optional)", ms: "Arahan untuk pelanggan (pilihan)", th: "คำแนะนำสำหรับลูกค้า (ไม่บังคับ)", fil: "Instruksyon para sa customer (opsyonal)", vi: "Hướng dẫn cho khách (tùy chọn)" },
  "payments.form.instructionsHelp": { id: "Ditampilkan ke kasir & pelanggan saat metode ini dipilih di Rental, Kasir, Home Rental, dan Membership. Isi QRIS statis milik outlet dan/atau rekening bank outlet — uang pelanggan masuk langsung ke outlet.", en: "Shown to the cashier & customer when this method is picked in Rental, POS, Home Rental and Membership. Use the outlet's own static QRIS and/or bank account — customer money goes straight to the outlet.", ms: "Dipaparkan kepada juruwang & pelanggan apabila kaedah ini dipilih di Sewa, Kasir, Home Rental dan Keahlian. Isi QRIS statik dan/atau akaun bank outlet.", th: "แสดงต่อแคชเชียร์และลูกค้าเมื่อเลือกวิธีนี้ในหน้าเช่า ขาย Home Rental และสมาชิก ใช้ QRIS และ/หรือบัญชีธนาคารของสาขาเอง", fil: "Ipinapakita sa cashier at customer kapag pinili ang paraang ito sa Rental, POS, Home Rental at Membership. Gamitin ang sariling static QRIS at/o bank account ng outlet.", vi: "Hiển thị cho thu ngân và khách khi chọn phương thức này ở Cho thuê, POS, Home Rental và Thành viên. Dùng QRIS tĩnh và/hoặc tài khoản ngân hàng của chính cửa hàng." },
  "payments.form.qrisUpload": { id: "Upload gambar QRIS", en: "Upload QRIS image", ms: "Muat naik gambar QRIS", th: "อัปโหลดรูป QRIS", fil: "Mag-upload ng QRIS image", vi: "Tải ảnh QRIS" },
  "payments.form.qrisRemove": { id: "Hapus gambar", en: "Remove image", ms: "Buang gambar", th: "ลบรูป", fil: "Alisin ang larawan", vi: "Xóa ảnh" },
  "payments.form.bankName": { id: "Nama bank (mis. BCA)", en: "Bank name (e.g. BCA)", ms: "Nama bank", th: "ชื่อธนาคาร", fil: "Pangalan ng bangko", vi: "Tên ngân hàng" },
  "payments.form.accountNumber": { id: "Nomor rekening", en: "Account number", ms: "Nombor akaun", th: "เลขบัญชี", fil: "Account number", vi: "Số tài khoản" },
  "payments.form.accountHolder": { id: "Atas nama", en: "Account holder", ms: "Nama pemegang akaun", th: "ชื่อบัญชี", fil: "Pangalan ng may-ari", vi: "Chủ tài khoản" },
  "payments.form.customerNote": { id: "Catatan untuk pelanggan (mis. kirim bukti transfer ke kasir)", en: "Note for the customer (e.g. show the transfer proof to the cashier)", ms: "Catatan untuk pelanggan", th: "หมายเหตุสำหรับลูกค้า", fil: "Paalala para sa customer", vi: "Ghi chú cho khách" },
  "payments.table.instructions": { id: "Arahan", en: "Instructions", ms: "Arahan", th: "คำแนะนำ", fil: "Instruksyon", vi: "Hướng dẫn" },
  "payments.uploading": { id: "Mengunggah…", en: "Uploading…", ms: "Memuat naik…", th: "กำลังอัปโหลด…", fil: "Nag-a-upload…", vi: "Đang tải…" },
