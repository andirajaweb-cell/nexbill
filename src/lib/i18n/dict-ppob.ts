...
registerDict({
  ...
  // --- Header ---
  "ppob.subtitle": {
    id: "Pencatatan transaksi PPOB (top up e-wallet, token listrik, pulsa, transfer, tarik tunai) — terpisah dari stok F&B, tetap satu accounting. Biaya dari provider PPOB yang Anda pakai dibukukan sebagai beban riil, terpisah dari margin toko yang Anda atur sendiri. Edit dan hapus permanen transaksi hanya bisa dilakukan akun Superuser.",
    en: "PPOB transaction records (e-wallet top-ups, electricity tokens, mobile credit, transfers, cash withdrawals) — kept separate from F&B stock, but still one accounting ledger. Fees charged by whichever PPOB provider you use are booked as a real expense, separate from the store margin you set yourself. Editing and permanently deleting transactions can only be done by a Superuser account.",
    ms: "Rekod transaksi PPOB (isi semula e-wallet, token elektrik, prabayar telefon, pemindahan, pengeluaran tunai) — berasingan daripada stok F&B, tetapi tetap satu perakaunan. Fi daripada pembekal PPOB yang anda guna direkodkan sebagai perbelanjaan sebenar, berasingan daripada margin kedai yang anda tetapkan sendiri. Sunting dan padam kekal transaksi hanya boleh dilakukan oleh akaun Superuser.",
    th: "บันทึกธุรกรรม PPOB (เติมเงินอีวอลเล็ต โทเค็นไฟฟ้า เติมเงินมือถือ โอนเงิน ถอนเงินสด) — แยกจากสต็อก F&B แต่ยังคงอยู่ในบัญชีเดียวกัน ค่าธรรมเนียมจากผู้ให้บริการ PPOB ที่คุณใช้จะถูกบันทึกเป็นค่าใช้จ่ายจริง แยกจากมาร์จิ้นร้านที่คุณกำหนดเอง การแก้ไขและลบธุรกรรมถาวรทำได้เฉพาะบัญชี Superuser เท่านั้น",
    fil: "Pagtatala ng transaksyon ng PPOB (top up ng e-wallet, token ng kuryente, load, padala ng pera, pag-withdraw ng cash) — hiwalay sa stock ng F&B, pero iisa pa rin ang accounting. Ang bayad mula sa PPOB provider na ginagamit mo ay itinatala bilang tunay na gastos, hiwalay sa margin ng tindahan na sarili mong itinakda. Ang pag-edit at permanenteng pagtanggal ng transaksyon ay puwede lang gawin ng Superuser account.",
    vi: "Ghi nhận giao dịch PPOB (nạp ví điện tử, mã token tiền điện, nạp thẻ điện thoại, chuyển khoản, rút tiền mặt) — tách riêng khỏi tồn kho F&B nhưng vẫn chung một sổ kế toán. Phí từ nhà cung cấp PPOB mà bạn sử dụng được ghi nhận là chi phí thực tế, tách biệt với biên lợi nhuận cửa hàng do bạn tự thiết lập. Chỉnh sửa và xóa vĩnh viễn giao dịch chỉ có thể thực hiện bởi tài khoản Superuser.",
  },
  ...
  "ppob.priceRules.description": {
    id: "Biaya provider diisi dari daftar tarif provider PPOB yang Anda pakai — margin sepenuhnya Anda atur sendiri. Keduanya jadi default saat kasir memilih produk ini, tapi tetap bisa diubah per transaksi.",
    en: "The provider fee is filled in from the rate list of whichever PPOB provider you use — the margin is entirely up to you. Both become the default when the cashier selects this product, but can still be changed per transaction.",
    ms: "Fi penyedia diisi daripada senarai kadar pembekal PPOB yang anda guna — margin sepenuhnya anda tetapkan sendiri. Kedua-duanya menjadi lalai apabila juruwang memilih produk ini, tetapi masih boleh diubah bagi setiap transaksi.",
    th: "ค่าธรรมเนียมผู้ให้บริการกรอกจากรายการอัตราของผู้ให้บริการ PPOB ที่คุณใช้ — ส่วนมาร์จิ้นคุณกำหนดเองทั้งหมด ทั้งสองค่าจะถูกใช้เป็นค่าเริ่มต้นเมื่อแคชเชียร์เลือกสินค้านี้ แต่ยังสามารถเปลี่ยนได้ต่อธุรกรรม",
    fil: "Ang bayad sa provider ay kinukuha mula sa listahan ng singil ng PPOB provider na ginagamit mo — ikaw mismo ang buong nagtatakda ng margin. Pareho itong magiging default kapag pinili ng cashier ang produktong ito, pero puwede pa ring baguhin kada transaksyon.",
    vi: "Phí nhà cung cấp được điền từ bảng giá của nhà cung cấp PPOB mà bạn sử dụng — biên lợi nhuận hoàn toàn do bạn tự thiết lập. Cả hai sẽ trở thành giá trị mặc định khi thu ngân chọn sản phẩm này, nhưng vẫn có thể thay đổi theo từng giao dịch.",
  },
  ...
  "ppob.priceRules.col.providerFee": { id: "Biaya Provider", en: "Provider Fee", ms: "Fi Pembekal", th: "ค่าธรรมเนียมผู้ให้บริการ", fil: "Bayad sa Provider", vi: "Phí nhà cung cấp" },
  ...
  "ppob.priceRules.providerFeePlaceholder": { id: "Biaya provider", en: "Provider fee", ms: "Fi pembekal", th: "ค่าธรรมเนียมผู้ให้บริการ", fil: "Bayad sa provider", vi: "Phí nhà cung cấp" },
  ...
  "ppob.field.providerFeePlaceholder": { id: "Biaya provider (beban)", en: "Provider fee (expense)", ms: "Fi pembekal (perbelanjaan)", th: "ค่าธรรมเนียมผู้ให้บริการ (ค่าใช้จ่าย)", fil: "Bayad sa provider (gastos)", vi: "Phí nhà cung cấp (chi phí)" },
  ...
  // --- Summary cards ---
  "ppob.summary.saldoProvider": { id: "Saldo Deposit PPOB", en: "PPOB Deposit Balance", ms: "Baki Deposit PPOB", th: "ยอดเงินฝาก PPOB", fil: "Balanse ng Deposit sa PPOB", vi: "Số dư ký quỹ PPOB" },
  ...
  "ppob.summary.providerFeeExpense": { id: "Beban Biaya Provider", en: "Provider Fee Expense", ms: "Perbelanjaan Fi Pembekal", th: "ค่าใช้จ่ายค่าธรรมเนียมผู้ให้บริการ", fil: "Gastos sa Bayad ng Provider", vi: "Chi phí nhà cung cấp" },
  ...
  "ppob.entryForm.providerRefPlaceholder": { id: "Ref. Provider (opsional, mis. Trx ID dari provider)", en: "Provider Ref (optional, e.g. the provider's Trx ID)", ms: "Ref. Pembekal (opsyenal, cth. Trx ID daripada pembekal)", th: "อ้างอิงผู้ให้บริการ (ไม่บังคับ เช่น Trx ID จากผู้ให้บริการ)", fil: "Ref. Provider (opsyonal, hal. Trx ID mula sa provider)", vi: "Mã tham chiếu nhà cung cấp (tùy chọn, vd. Trx ID từ nhà cung cấp)" },
});
